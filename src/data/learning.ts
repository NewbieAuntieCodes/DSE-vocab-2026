...
export const learningWordList: WordList = {
  ...
  words: [
    ...
    word_attend,
    { word: 'schedule', emoji: '🗓️', phonetic: '/ˈskedʒuːl/', definition: '日程表；计划', example: 'What\'s your schedule for next week?', category: 'basic' },
    ...
    { word: 'feedback', emoji: '💬', phonetic: '/ˈfiːdbæk/', definition: '反馈意见', example: 'We received a lot of positive feedback from our customers.', category: 'basic' },
    { word: 'receive', emoji: '📥', phonetic: '/rɪˈsiːv/', definition: '收到；接收', example: 'Did you receive my email?', category: 'basic' },
