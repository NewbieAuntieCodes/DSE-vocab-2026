...
export const word_boost: Word = { word: "boost", emoji: "🚀", phonetic: "/buːst/", definition: "增强；提高", example: "Regular exercise can boost your energy levels." };
export const word_brave: Word = { word: "brave", emoji: "🦁", phonetic: "/breɪv/", definition: "勇敢的", example: "It was brave of the climber to attempt the difficult route." };
export const word_breath: Word = { word: "breath", emoji: "😮‍💨", phonetic: "/breθ/", definition: "呼吸；气息", example: "Take a deep breath and relax before you start." };
export const word_broaden: Word = { word: "broaden", emoji: "🌍", phonetic: "/ˈbrɔːdn/", definition: "拓宽；使变宽", example: "Travel can help to broaden your horizons.", category: "advanced" };
