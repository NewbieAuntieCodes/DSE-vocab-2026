...
export const word_hang_out: Word = { word: "hang out", emoji: "👫", phonetic: "/hæŋ aʊt/", definition: "（与朋友）待在一起；闲逛", example: "Do you want to hang out at the mall this weekend?" };
export const word_influence: Word = { word: "have huge influence on", emoji: "🌊", phonetic: "/hæv hjuːdʒ ˈɪnfluəns ɒn/", definition: "对...有巨大影响", example: "Social media can have a huge influence on young people.", category: "advanced" };
export const word_health_risk: Word = { word: "health risk", emoji: "⚠️", phonetic: "/helθ rɪsk/", definition: "健康风险", example: "Breathing polluted air poses a significant health risk, especially for children.", category: "basic" };
export const word_heavy_tax: Word = { word: "heavy tax", emoji: "💸", phonetic: "/ˈhevi tæks/", definition: "重税", example: "A heavy tax on petrol could encourage people to use public transport.", category: "basic" };
